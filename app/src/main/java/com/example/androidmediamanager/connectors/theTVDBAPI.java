...
public class theTVDBAPI extends AsyncTask<URL, Integer, Long> implements Connector {

  private static String CONNECTOR_NAME = "theTVDBAPI";

  final OkHttpClient client = new OkHttpClient();
  final String host = "https://api.thetvdb.com/";
